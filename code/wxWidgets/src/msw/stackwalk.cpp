...
void wxStackFrame::OnGetName()
{
    ...
    if ( wxDbgHelpDLL::SymGetModuleInfo( ::GetCurrentProcess(), (DWORD)m_address, &moduleInfo ) )
    {
       m_module = moduleInfo.ModuleName;
       m_unmappedAddress = wx_reinterpret_cast(void*, (DWORD)m_address - moduleInfo.BaseOfImage); 
    }

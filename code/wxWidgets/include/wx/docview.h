...
public:
    ...
    // Find existing open documents
    wxDocument* FindDocument(const wxString &path) const;
    int FindDocuments(wxDocTemplate *temp, wxList &docs ) const;
    ...
    const wxList& GetDocuments() const { return m_docs; }
    wxList& GetTemplates() { return m_templates; }
    const wxList& GetTemplates() const { return m_templates; }
